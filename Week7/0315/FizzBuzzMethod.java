...
public class FizzBuzzMethod extends CommandLineProgram{
  ...
  public void run(){
    ...
    */
    println("About to call the FizzBuzz method");
    doFizzBuzz();
    println("Returned to run() from the FizzBuzz method");
  }
  
  private void doFizzBuzz(){
    println("In the FizzBuzz method");
    ...
    println("Exiting FizzBuzz method");
  }
